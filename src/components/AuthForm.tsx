...
const AuthForm: React.FC = () => {
  ...
  const fieldClassName =
    "w-full rounded-xl border border-slate-200 bg-slate-50/70 px-4 py-3.5 text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-300 focus:border-rose-700 focus:bg-white focus:ring-4 focus:ring-rose-100";
  ...
  return (
    <form
      ...
      className="w-full rounded-[2rem] border border-white bg-white p-5 shadow-[0_24px_70px_rgba(36,28,30,.10)] sm:p-8 md:p-10"
    >
      ...
      <div className="mb-6">
        <h2 className="text-2xl font-black tracking-tight text-slate-950 sm:text-3xl">{t('requestTitle')}</h2>
      ...
      <button
        ...
        className="w-full rounded-xl bg-[#991f36] px-6 py-4 font-bold text-white shadow-[0_12px_28px_rgba(153,31,54,.22)] transition hover:-translate-y-0.5 hover:bg-[#7d172b] disabled:cursor-not-allowed disabled:opacity-60"
      >
